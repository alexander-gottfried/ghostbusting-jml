...
enum ts_symbol_identifiers {
  ...
  anon_sym_LT_EQ_EQ = 28,
  anon_sym_LT_EQ_EQ_GT = 29,
  anon_sym_LT_EQ_BANG_EQ_GT = 30,
  sym_decimal_integer_literal = 31,
  sym_true = 32,
  sym_false = 33,
  sym_integral_type = 34,
  sym_boolean_type = 35,
  ...
  anon_sym_ensures = 40,
  anon_sym_post = 41,
  anon_sym_invariant = 42,
  anon_sym_ghost = 43,
  anon_sym_final = 44,
  anon_sym_BSLASHold_LPAREN = 45,
  sym_program = 46,
  sym__toplevel_statement = 47,
  sym_variable_declaration = 48,
  sym__variable_id = 49,
  sym_method_declaration = 50,
  sym__method_header = 51,
  sym_parameters = 52,
  sym_parameter = 53,
  sym_block = 54,
  sym__expression = 55,
  ...
  sym_jml_requires = 62,
  sym_jml_ensures = 63,
  sym__jml_toplevel_annotation = 64,
  sym_jml_invariant = 65,
  sym_jml_ghost_declaration = 66,
  sym_jml_old = 67,
  aux_sym_program_repeat1 = 68,
  aux_sym_parameters_repeat1 = 69,
  aux_sym_jml_contract_repeat1 = 70,
};
...
static const char * const ts_symbol_names[] = {
  ...
  [anon_sym_BSLASHold_LPAREN] = "\\old(",
  [sym_program] = "program",
  [sym__toplevel_statement] = "_toplevel_statement",
  [sym_variable_declaration] = "variable_declaration",
  [sym__variable_id] = "_variable_id",
  ...
  [sym__type] = "_type",
  [sym_jml_contract] = "jml_contract",
  [sym__jml_clause] = "_jml_clause",
  [sym_jml_requires] = "jml_requires",
  [sym_jml_ensures] = "jml_ensures",
  [sym__jml_toplevel_annotation] = "_jml_toplevel_annotation",
  [sym_jml_invariant] = "jml_invariant",
  [sym_jml_ghost_declaration] = "jml_ghost_declaration",
  [sym_jml_old] = "jml_old",
  [aux_sym_program_repeat1] = "program_repeat1",
  [aux_sym_parameters_repeat1] = "parameters_repeat1",
  [aux_sym_jml_contract_repeat1] = "jml_contract_repeat1",
};
...
static const TSSymbol ts_symbol_map[] = {
  ...
  [anon_sym_LT_EQ_BANG_EQ_GT] = anon_sym_LT_EQ_BANG_EQ_GT,
  ...
  [anon_sym_BSLASHold_LPAREN] = anon_sym_BSLASHold_LPAREN,
  [sym_program] = sym_program,
  [sym__toplevel_statement] = sym__toplevel_statement,
  [sym_variable_declaration] = sym_variable_declaration,
  [sym__variable_id] = sym__variable_id,
  ...
  [sym__type] = sym__type,
  [sym_jml_contract] = sym_jml_contract,
  [sym__jml_clause] = sym__jml_clause,
  [sym_jml_requires] = sym_jml_requires,
  [sym_jml_ensures] = sym_jml_ensures,
  [sym__jml_toplevel_annotation] = sym__jml_toplevel_annotation,
  [sym_jml_invariant] = sym_jml_invariant,
  [sym_jml_ghost_declaration] = sym_jml_ghost_declaration,
  [sym_jml_old] = sym_jml_old,
  [aux_sym_program_repeat1] = aux_sym_program_repeat1,
  [aux_sym_parameters_repeat1] = aux_sym_parameters_repeat1,
  [aux_sym_jml_contract_repeat1] = aux_sym_jml_contract_repeat1,
};
...
static bool ts_lex(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    case 0:
      ...
      if (set_contains(sym_identifier_character_set_1, 669, lookahead)) ADVANCE(50);
      END_STATE();
    case 1:
    ...
    case 44:
      ...
      END_STATE();
    case 45:
      ACCEPT_TOKEN(anon_sym_LT_EQ_BANG_EQ_GT);
      END_STATE();
    case 46:
    ...
    case 50:
      ...
      if (set_contains(sym_identifier_character_set_2, 778, lookahead)) ADVANCE(50);
      END_STATE();
    case 51:
    ...
    case 52:
      ...
      END_STATE();
    case 53:
      ACCEPT_TOKEN(anon_sym_BSLASHold_LPAREN);
      END_STATE();
    default:
      return false;
  }
...
static bool ts_lex_keywords(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    ...
    case 23:
      ...
      END_STATE();
    case 24:
      ACCEPT_TOKEN(sym_integral_type);
      END_STATE();
    case 25:
...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  [0] = {
    ...
    [anon_sym_LT_EQ_BANG_EQ_GT] = ACTIONS(1),
    [sym_decimal_integer_literal] = ACTIONS(1),
    [sym_true] = ACTIONS(1),
    [sym_false] = ACTIONS(1),
    [sym_integral_type] = ACTIONS(1),
    ...
    [anon_sym_BSLASHold_LPAREN] = ACTIONS(1),
  },
  [1] = {
    [sym_program] = STATE(67),
    [sym__toplevel_statement] = STATE(19),
    [sym_variable_declaration] = STATE(19),
    [sym__variable_id] = STATE(40),
    [sym_method_declaration] = STATE(19),
    [sym__method_header] = STATE(58),
    [sym_jml_contract] = STATE(68),
    [sym__jml_toplevel_annotation] = STATE(19),
    [aux_sym_program_repeat1] = STATE(19),
    [aux_sym_jml_contract_repeat1] = STATE(49),
    [ts_builtin_sym_end] = ACTIONS(3),
    [sym_identifier] = ACTIONS(5),
    [anon_sym_SLASH_SLASH_AT] = ACTIONS(7),
  },
};
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [9] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_binary_expression, 3, 0, 9),
  ...
  [45] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_variable_declaration, 3, 0, 5),
  [47] = {.entry = {.count = 1, .reusable = true}}, SHIFT(28),
  [49] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_jml_old, 3, 0, 0),
  [51] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_jml_old, 3, 0, 0),
  [53] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_jml_ensures, 2, 0, 0),
  [55] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_jml_invariant, 2, 0, 0),
  [57] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_jml_requires, 2, 0, 0),
  ...
  [63] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_program_repeat1, 2, 0, 0), SHIFT_REPEAT(39),
  [66] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_program_repeat1, 2, 0, 0), SHIFT_REPEAT(21),
  ...
  [143] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__variable_id, 1, 0, 1),
  [145] = {.entry = {.count = 1, .reusable = true}}, SHIFT(41),
  [147] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_variable_declaration, 1, 0, 2),
  ...
  [161] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_jml_contract_repeat1, 2, 0, 0),
  [163] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_jml_contract_repeat1, 2, 0, 0), SHIFT_REPEAT(38),
  [166] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_parameters_repeat1, 2, 0, 0), SHIFT_REPEAT(43),
  [169] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_parameters_repeat1, 2, 0, 0),
  [171] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_method_declaration, 2, 0, 4),
  [173] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_jml_contract, 1, 0, 0),
  [175] = {.entry = {.count = 1, .reusable = true}}, SHIFT(38),
  [177] = {.entry = {.count = 1, .reusable = true}}, SHIFT(45),
  [179] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__jml_toplevel_annotation, 3, 0, 0),
  ...
  [189] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parameter, 2, 0, 7),
  [191] = {.entry = {.count = 1, .reusable = true}}, SHIFT(65),
  [193] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_jml_contract_repeat1, 3, 0, 0),
  [195] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parameters, 4, 0, 0),
  [197] = {.entry = {.count = 1, .reusable = true}}, SHIFT(64),
  [199] = {.entry = {.count = 1, .reusable = true}}, SHIFT(8),
  [201] = {.entry = {.count = 1, .reusable = true}}, SHIFT(54),
  [203] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_jml_ghost_declaration, 3, 0, 8),
  ...
  [211] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__method_header, 2, 0, 3),
  [213] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__method_header, 3, 0, 6),
  [215] = {.entry = {.count = 1, .reusable = true}}, SHIFT(52),
  [217] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parameters, 3, 0, 0),
  [219] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parameters, 2, 0, 0),
  [221] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_jml_ghost_declaration, 4, 0, 10),
};
...
TS_PUBLIC const TSLanguage *tree_sitter_java_jml_subset(void) {
